...
- ✅ **API bilingüe** - Métodos disponibles en español e inglés
...
void setup() {
    ...
    // Puedes usar nombres en español o inglés
    if (RTC::beginConMultiplesServidores()) {
        // O: RTC::beginWithMultipleServers()
...
> 🌍 **Nota:** Todos los métodos están disponibles en español e inglés.

### RTC::beginConMultiplesServidores() / beginWithMultipleServers()
...
if (RTC::beginConMultiplesServidores(30000)) {
    // O en inglés: RTC::beginWithMultipleServers(30000)
